 ...
 * See https://github.com/aspnet-contrib/AWA.Util.OAuth.Providers
...
using static AWA.Util.OAuth.Weibo.WeiboAuthenticationConstants;

namespace AWA.Util.OAuth.Weibo
{
    /// <summary>
